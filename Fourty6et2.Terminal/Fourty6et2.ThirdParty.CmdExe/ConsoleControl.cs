...
namespace Fourty6et2.ThirdParty.CmdExe.ConsoleControl
{
    /// <summary>
    ...
    /// </summary>
    [ToolboxBitmap(typeof(resfinder), "Fourty6et2.ThirdParty.CmdExe.ConsoleControl.Fourty6et2.ThirdParty.CmdExe.ConsoleControl.bmp")]
    public partial class ConsoleControl : UserControl
    {
        public event EventHandler ExeTerminated = delegate { };

        /// <summary>
        /// Initializes a new instance of the <see cref="Fourty6et2.ThirdParty.CmdExe.ConsoleControl"/> class.
        /// </summary>
        public ConsoleControl()
        {
            ...
            processInterace.OnProcessOutput += new Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventHanlder(processInterace_OnProcessOutput);
            processInterace.OnProcessError += new Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventHanlder(processInterace_OnProcessError);
            processInterace.OnProcessInput += new Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventHanlder(processInterace_OnProcessInput);
            processInterace.OnProcessExit += new Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventHanlder(processInterace_OnProcessExit);
        ...
        /// <param name="args">The <see cref="Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs"/> instance containing the event data.</param>
        void processInterace_OnProcessError(object sender, Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs args)
        {
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="args">The <see cref="Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs"/> instance containing the event data.</param>
        void processInterace_OnProcessOutput(object sender, Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs args)
        {
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="args">The <see cref="Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs"/> instance containing the event data.</param>
        void processInterace_OnProcessInput(object sender, Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs args)
        {
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="args">The <see cref="Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs"/> instance containing the event data.</param>
        void processInterace_OnProcessExit(object sender, Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessEventArgs args)
        {
            ...
            ExeTerminated(this, EventArgs.Empty);
        }
...
//WriteInput("\x3", Color.White, false);
            ...
            if (e.KeyCode == Keys.Return)
            {
                ...
                if (length > 0)
                {
                    string input = richTextBoxConsole.Text.Substring(startIndex, length);
        ...
        public void WriteOutput(string output, Color color)
        {
            ...
            Invoke((Action)(() =>
            {
                ...
                richTextBoxConsole.Select(richTextBoxConsole.Text.Length, 1);
            }));
        }
        ...
        /// </summary>
        private Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessInterface processInterace = new Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessInterface();
        ...
        /// </summary>
        [Browsable(false)]
        public Fourty6et2.ThirdParty.CmdExe.ProcessInterface.ProcessInterface ProcessInterface
        {
